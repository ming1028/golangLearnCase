...
require (
	...
	github.com/DeanThompson/zhihu-go v0.0.0-20161115024108-97580e6df9fe // indirect
...
replace github.com/golangLearnCase => github.com/ming1028/golangLearnCase v0.0.1
